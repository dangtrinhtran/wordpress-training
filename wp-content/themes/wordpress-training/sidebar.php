 <div id="sidebar" class="col-md-3">
                                <div id="holiday">
                                    ...
                                    <p class="choose">Chọn nơi bạn muốn tham quan :</p>

                                    <form action="">
                                        <p><input type="text" placeholder="Chọn khu vực ..." /></p>
                                        <p><input type="text" placeholder="Chọn ngày du lịch ..." /></p>
                                        <p><input type="text" placeholder="Chọn chủ đề ..." /></p>
                                        <p><input type="text" placeholder="Chọn mức giá ..." /></p>
                                ...
                                <div id="quick">
                                    ...
                                    <form action="">
                                        <p><input type="text" placeholder="Country/Code..." class="short" /></p>
                                ...
                                <div id="newsletter">
                                    ...
                                    <form action="">
                                        <p><input type="text" placeholder="Country/Code ..." /></p>
                                        <p><input type="text" placeholder="Search ..." class="short" /></p>
                                        <p><input type="submit" value="Sign up" class="uppercase submit" /></p>
                                    </form>
                                </div><!--end #newsletter-->

                                <div id="lastest_new">
                                    <h3 class="uppercase bold">Lastest new</h3>
